...
class NextcloudUser(HttpUser):
    ...
    def on_start(self):
        user_idx = random.randrange(1, 40)
        self.user_name = f'user{user_idx}'
        self.auth = HTTPBasicAuth(self.user_name, "pK#$VXcxi[t'vKk")
    ...
    def upload_file_1kb(self):
        remote_path = f"/remote.php/dav/files/{self.user_name}" #/remote.php/dav/files/   /1kb_file_{random.randrange(0, 10)}
    ...
    def upload_file_1mb(self):
        remote_path = f"/remote.php/dav/files/{self.user_name}" #/remote.php/dav/files/   /1mb_file_{random.randrange(0, 10)}
